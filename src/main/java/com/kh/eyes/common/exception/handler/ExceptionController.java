package com.kh.eyes.common.exception.handler;
...
import com.kh.eyes.common.exception.CustomException;
...
public class ExceptionController {
	...
	public String dataAccessExcepeionHandler(DataAccessException e, Model model) {
